# ev3-myo #
![ev3-myo](http://i.imgur.com/7xRapBE.jpg "ev3-myo") 
...
* [Pair the EV3 brick with your computer via Bluetooth and create PAN](https://sourceforge.net/p/lejos/wiki/Configuring%20Bluetooth%20PAN/) 
	* Every time you reboot or disconnect from Bluetooth PAN and you want to work with the EV3 brick again, you need to go to Control Panel > Hardware and Sound > Devices and Printers > right-click on you EV3 brick > Connect using > Access point to connect to the EV3 brick. You can also create a shortcut. 
## To train your own models using the neural-net project you will require ## 
* [Anaconda](https://www.anaconda.com/download/) 
	* Use Jupyter Notebook to open the neural-net.ipynb file in neural-net, subfolder 
...
* ev3-myo 
	* The main project in Java that enables robot control 
* neural-net 
	* Script for training the neural network 